...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $selectcottage = $_POST['selectcottage'];
    $checkin = $_POST['checkin'];
    $checkout = $_POST['checkout'];
    $guests = $_POST['guests'];
    $reference = $_POST['reference'];

    $sql = "INSERT INTO reservations (first_name, last_name, middle_name, contact_number, email, address, note, check_in_date, check_out_date, reservation_type, select_cottage, check_in, check_out, guests, reference) 
    VALUES ('$firstname', '$lastname', '$middlename', '$contact_number', '$email', '$address', '$note', '$checkindate', '$checkoutdate', '$reservationtype', '$selectcottage', '$checkin', '$checkout', '$guests', '$reference')";
